...
def check_gradient_dconv():
    ...
    # pdb.set_trace()
    # (Pdb) pp input.size(), offset.size(), mask.size(), weight.size(), bias.size()
    # (torch.Size([2, 2, 4, 4]),
    #  torch.Size([2, 18, 4, 4]),
    #  torch.Size([2, 9, 4, 4]),
    #  torch.Size([2, 2, 3, 3]),
    ...
    # (Pdb) pp stride, padding, dilation, deformable_groups
    # (1, 1, 1, 1)
...
if __name__ == '__main__':
    ...
    print("Checking pooling zero offset on CPU ...")
    check_pooling_zero_offset()
    # zero offset check
    if inC == outC:
        print("Checking zero offset on CPU ...")
        check_zero_offset()

    print("Checking gradient dpooling on CPU ...")
    check_gradient_dpooling()

    print("Checking gradient dconv on CPU ...")
